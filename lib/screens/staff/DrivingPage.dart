...
class DrivingPage extends StatefulWidget {
  ...
  final int? whichCar;
  const DrivingPage({super.key, required this.routeID, required this.startPosition, required this.whichCar});
...
class DrivingState extends State<DrivingPage> {
  ...
  void initState() {
    super.initState();
    setState(() { routeID = widget.routeID; _passedLocation = widget.startPosition; whichCar = widget.whichCar; });
    _startLocationTimer();
  }
